...
(function () {
  ...
  const TRANSLATIONS = {
    sv: {
      ...
      'index.find.inflytt.body': 'Steg vid ankomst, städning under vistelsen och avreschecklistan med 10 punkter.',
      ...
      'inflytt.lede': 'Tre steg vid ankomst. Tre städrutiner under vistelsen. Tio punkter på avreschecklistan. Inget mer, inget mindre.',
    ...
    en: {
      ...
      'index.find.inflytt.body': 'Steps on arrival, cleaning during the stay and the 10-point departure checklist.',
      ...
      'inflytt.lede': 'Three steps on arrival. Three cleaning routines during the stay. Ten points on the departure checklist. Nothing more, nothing less.',
